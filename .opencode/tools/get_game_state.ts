...
export default tool({
  description:
    "Get current game state as a text grid showing entity positions. Grid uses coordinates with x (horizontal/left-to-right) and y (vertical/top-to-bottom), starting at (1,1) at top-left. Multiple entities in same cell shown as 'entity1<entity2'. Text objects prefixed with 'text_' (e.g., 'text_baba').",
  args: {
