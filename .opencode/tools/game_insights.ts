...
export default tool({
  description:
    ...
    "YOU positions {x, y}, WIN positions {x, y}, and path to win if reachable. " +
    "Coordinates: x is horizontal (left-to-right), y is vertical (top-to-bottom), starting at (1,1) at top-left.",
  args: {},
